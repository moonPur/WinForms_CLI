В проекте SimpleForm представлена простейшая реализация двух форм, на первой форме добавляются Данные имени и Фамилии, а на Второй форме они отображаются. 
